...
namespace Domain.Services.Implementations
{
    public class TasaService : ITasaService
    {
        ...
        public Response Grabar_TasaUnfv(TasaEntity tasaEntity, SaveOption saveOption)
        {
            ResponseData result;
            ...
            switch (saveOption)
            {
                case SaveOption.Insert:
                    ...
                    var grabarTasaUnfv = new USP_I_GrabarTasaUnfv()
                    {
                    ...
                    result = grabarTasaUnfv.Execute();

                    break;

                case SaveOption.Update:
                    var actualizarTasaUnfv = new USP_U_ActualizarTasaUnfv()
                    {
                    ...
                    result = actualizarTasaUnfv.Execute();
